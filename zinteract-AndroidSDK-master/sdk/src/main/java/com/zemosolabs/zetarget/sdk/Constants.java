...
class Constants {
   ...
   // static String Z_BASE_URL1 = "http://devapi.zetarget.com";
...
//    static final String Z_CAMPAIGN_DONOT_SHOW_EVENT = "zmobile.campaign_dont_show";
    ...
    static final String Z_DB_IN_APP_TABLE_NAME ="in_app";
    static final String Z_DB_IN_APP_CHANGED_TEXT_FIELD_NAME ="changed_text";
    static final String Z_DB_IN_APP_CHANGED_LOCALE_FIELD_NAME="locale";
    ...
    static String Z_IN_APP_TEXT = Z_BASE_URL + "fetchDataStore";
