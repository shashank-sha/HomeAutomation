        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
              ...
              //  holder.message_From = (TextView) convertView.findViewById(R.id.name);
                ...
                holder.date =(TextView) convertView.findViewById(R.id.phone);
         ...
         //   holder.message_From.setText(searchArrayList.get(position).getFrom_Name());
            ...
            holder.date.setText(new SimpleDateFormat("HH:mm", Locale.ENGLISH).format(searchArrayList.get(position).getDateTime()));
